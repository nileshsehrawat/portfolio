...
export const ServicesSummary = () => {
  ...
  return (
    <section className="overflow-hidden px-4 py-24 text-center font-light text-2xl leading-snug sm:px-8 md:text-4xl lg:py-36 lg:text-6xl">
      ...
      <div
        className="-translate-x-2/5 flex items-center justify-center"
        id="title-service-2"
      >
        <p className="font-bold">Engineering</p>
        <ImagePill
          className="!m-2 max-w-24 rounded-xl p-0"
          image="https://picsum.photos/600/400?random=1"
        />
        <p>Deployment</p>
      </div>
      <div
        className="flex translate-x-2/5 items-center justify-center"
        id="title-service-3"
      >
        <p>APIs</p>
        <ImagePill
        ...
        />
        <p className="font-normal italic">React UIs</p>
        <ImagePill
          className="!m-2 max-w-24 rounded-xl p-0"
